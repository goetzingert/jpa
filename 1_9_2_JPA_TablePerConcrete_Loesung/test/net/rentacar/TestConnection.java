...
public class TestConnection extends AbstractJPATestCase {
	...
	public void setUp() throws Exception {
		...
		Shop shop1 = new Shop("1", "Muenchen");
		Shop shop2 = new Shop("2", "Stuttgart");
		manager.persist(shop1);
		manager.persist(shop2);
		Vehicle vehicle = new Vehicle("1", shop1, vehicleType);
		vehicle.setLocation(shop2);
	...
	@Test public void testFindPersonByUser() {
		assertNotNull(super.manager.find(User.class, "1").getPerson()
				.getFirstName());
	}
