...
public class TestQuery extends AbstractJPATestCase {
	...
	public void setUp() throws Exception {
		...
		vehicleVW = new Vehicle(shop, vehicleTypeVW);
		vehicleVW.setLocation(new Shop("Stuttgart"));
		manager.persist(vehicleVW);
	...
	@Test
	public void testForVehicleInShop() throws InterruptedException {
