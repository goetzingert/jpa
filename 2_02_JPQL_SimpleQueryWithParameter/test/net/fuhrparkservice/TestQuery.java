...
public class TestQuery extends AbstractJPATestCase {
	...
	@Test public void testQueryForVehicleTypesMoreThen130HPWithParameter() {
		// TODO Gleiche Anfrage nur Unter Nutzung der Parameter in Where Klausel
		int numberOfVehicleTypes = -1;
		assertEquals(1, numberOfVehicleTypes);
	}
}
