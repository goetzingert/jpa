...
public class TestNamedQuery extends AbstractJPATestCase {
	...
	public void setUp() throws Exception {
		...
		vehicleItem = new Vehicle(muenchen, Vehicle);
		...
		this.createReservierung(customer2, vehicleItem, muenchen, 110,
		...
		this.createReservierung(customer, vehicleItem2, muenchen, 440,
